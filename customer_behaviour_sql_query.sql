...
select item_purchased, round(avg(review_rating),2) as Avergae_product_review
from customer
...
with item_count as( select category, item_purchased, count(customer_id) as total_order,
